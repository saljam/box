...
Elm.Box.make = function (_elm) {
   ...
   var thicknessc = $Signal.channel("3");
   var kerfc = $Signal.channel("0");
   var tabc = $Signal.channel("10");
   var lengthc = $Signal.channel("50");
   var heightc = $Signal.channel("50");
   var widthc = $Signal.channel("100");
   var inputFor = F2(function (channel,
   val) {
   ...
   var segmentSizes = F2(function (length,
   tabsize) {
      return function () {
         var segments = ($Basics.floor(length / tabsize) / 2 | 0) * 2 + 1;
         return {ctor: "_Tuple3"
                ,_0: length / $Basics.toFloat(segments)
                ,_1: length / $Basics.toFloat(segments)
                ,_2: segments};
      }();
   });
   var side = F6(function (length,
   tabsize,
   kerf,
   thickness,
   tabstart,
   flip) {
      return function () {
         ...
         ntab = $._2;
         var last = ntab - 1;
         var tablen$ = tablen$$ + kerf;
         var firsttab$ = tablen$ - kerf / 2;
         var gaplen$ = gaplen$$ - kerf;
         var firstgap$ = gaplen$ + kerf / 2;
         var $ = flip ? {ctor: "_Tuple2"
                        ,_0: firstgap$
                        ,_1: firsttab$} : {ctor: "_Tuple2"
                                          ,_0: firsttab$
                                          ,_1: firstgap$},
         firsttab = $._0,
         firstgap = $._1;
         ...
         var nthy = function (n) {
            return function () {
               var halfn = $Basics.toFloat((n - 1) / 2 | 0);
               return (tabstart ? firsttab : firstgap) + tablen * halfn + gaplen * halfn + (even(n - 1) ? 0 : tabstart ? tablen : gaplen);
            }();
         };
         var pnt = function (n) {
            return _U.eq(even(n),
            tabstart) ? _L.fromArray([{ctor: "_Tuple2"
                                      ,_0: 0
                                      ,_1: nthy(n)}
                                     ,{ctor: "_Tuple2"
                                      ,_0: 0
                                      ,_1: nthy(n) + tablen}]) : _L.fromArray([{ctor: "_Tuple2"
                                                                               ,_0: thickness
                                                                               ,_1: nthy(n)}
                                                                              ,{ctor: "_Tuple2"
                                                                               ,_0: thickness
         ...
         tabstart ? _L.fromArray([{ctor: "_Tuple2"
                                 ...
                                 ,{ctor: "_Tuple2"
                                  ,_0: 0
                                  ,_1: firsttab}]) : _L.fromArray([{ctor: "_Tuple2"
                                                                   ,_0: thickness
                                                                   ,_1: 0}
                                                                  ,{ctor: "_Tuple2"
                                                                   ,_0: thickness
         ...
         tabstart) ? _L.fromArray([{ctor: "_Tuple2"
                                  ...
                                  ,{ctor: "_Tuple2"
                                   ,_0: thickness
                                   ,_1: nthy(last) + firstgap}]) : _L.fromArray([{ctor: "_Tuple2"
                                                                                 ,_0: 0
                                                                                 ,_1: nthy(last)}
                                                                                ,{ctor: "_Tuple2"
                                                                                 ,_0: 0
                                                                                 ,_1: nthy(last) + firsttab}])));
      }();
   });
   var panel = F6(function (length,
   width,
   tabsize,
   kerf,
   thickness,
   tabs) {
      return function () {
         var top = $List.reverse(rotate(A6(side,
         width,
         tabsize,
         kerf,
         thickness,
         tabs.top,
         false)));
         var right = A2(translate,
         width - thickness,
         0)($List.reverse(A6(side,
         length,
         tabsize,
         kerf,
         thickness,
         $Basics.not(tabs.right),
         true)));
         var bottom = A2(translate,
         0,
         length - thickness)(rotate(A6(side,
         width,
         tabsize,
         kerf,
         thickness,
   ...
   thickness) {
      return function () {
         ...
         ,right: true
         ,top: false});
         var cheight = $List.maximum(A2($List.map,
         $Basics.snd,
         c));
         var b = A6(panel,
         length,
         ...
         ,right: false
         ,top: false});
         var bwidth = $List.maximum(A2($List.map,
         $Basics.fst,
         b));
         var a = A6(panel,
         length,
         ...
         ,right: true
         ,top: true});
         var awidth = $List.maximum(A2($List.map,
         $Basics.fst,
         a));
         var svgw = awidth + bwidth + 20;
         var aheight = $List.maximum(A2($List.map,
         $Basics.snd,
         a));
         var svgh = aheight + cheight + 20;
         return A2($Svg.svg,
         _L.fromArray([A2($Html$Attributes.attribute,
                      "width",
                      A2($Basics._op["++"],
                      $Basics.toString(svgw),
                      "mm"))
                      ,A2($Html$Attributes.attribute,
                      "height",
                      A2($Basics._op["++"],
                      $Basics.toString(svgh),
                      "mm"))
                      ,A2($Html$Attributes.attribute,
                      "viewBox",
                      A2($Basics._op["++"],
         ...
         _L.fromArray([A2($Svg.g,
                      _L.fromArray([$Svg$Attributes.transform("translate(5,5)")]),
                      _L.fromArray([A2($Svg.polyline,
                      _L.fromArray([$Svg$Attributes.fill("none")
   ...
   thickStr) {
      return function () {
         var _v12 = {ctor: "_Tuple6"
                    ,_0: $String.toFloat(wStr)
                    ,_1: $String.toFloat(hStr)
                    ,_2: $String.toFloat(lStr)
                    ,_3: $String.toFloat(tabStr)
                    ,_4: $String.toFloat(kerfStr)
                    ,_5: $String.toFloat(thickStr)};
         switch (_v12.ctor)
         {case "_Tuple6":
            switch (_v12._0.ctor)
              {case "Ok":
                 switch (_v12._1.ctor)
                   ...
                   break;}
              break;}
         return $Html.text("bad input :-/");
      }();
   });
   var page = F6(function (w,
   h,
   l,
   tab,
   kerf,
   thickness) {
      ...
      _L.fromArray([A2($Html.h1,
                   _L.fromArray([]),
                   _L.fromArray([$Html.text("Box-Joint-O-Matic")]))
                   ,A2($Html.form,
                   _L.fromArray([]),
                   _L.fromArray([A2($Html.label,
                                _L.fromArray([]),
                                _L.fromArray([$Html.text("outside dimentions ")
                                             ,A2(inputFor,lengthc,l)
                                             ,$Html.text(" × ")
                                             ,A2(inputFor,widthc,w)
                                             ,$Html.text(" × ")
                                             ,A2(inputFor,heightc,h)]))
                                ,A2($Html.label,
                                _L.fromArray([]),
                                _L.fromArray([$Html.text("tab width ")
                                             ,A2(inputFor,tabc,tab)]))
                                ,A2($Html.label,
                                _L.fromArray([]),
                                _L.fromArray([$Html.text("material thickness ")
                                             ,A2(inputFor,
                                             thicknessc,
                                             thickness)]))
                                ,A2($Html.label,
                                _L.fromArray([]),
                                _L.fromArray([$Html.text("kerf compensation ")
                                             ,A2(inputFor,kerfc,kerf)]))]))
                   ,A6(boxBlock,
                   w,
                   h,
                   l,
                   ...
                   thickness)
                   ,A2($Html.footer,
                   _L.fromArray([$Html$Attributes.$class("mono")]),
